...
class Command:  # pylint: disable=too-many-instance-attributes
    ...
    def run(
        ...
        if self.last_telemetry is not None and current_telemetry.time_since_boot is not None and self.last_telemetry.time_since_boot is not None: 
        ...
        self.connection.mav.command_long_send(
            ...
            confirmation = 0, 
            param1 = 1, 
            param2 = 0, param3 = 0, param4 = 0, param5 = 0, param6 = 0, param7 = self.target.z
        )
